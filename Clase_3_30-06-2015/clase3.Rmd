...
$$Ct = \alpha_1 + \alpha_2 P_t + \alpha_3 P_{t-1} + \alpha_4 (WP_t + WG_t)$$
$$I_t = \beta_1 + \beta_2 P_t + \beta_3 P_{t-1} - \beta_4 K_{t-1}$$
$$WPt = \gamma_1 + \gamma_2 X_t + \gamma_3 X_{t-1} + \gamma_4 A$$
$$Pt = X_t - WP_t - T_t$$
$$K_t = K_{t-1} + I_t$$
$$X_t = C_t + I_t + G_t$$
...
El paper original utiliza una metodología denominada Mínimos Cuadrados en dos Etapas y luego Structural Equation Modelling ¿por qué?

Estas son las regresiones con la metodología del paper original:
```{r klein3}
